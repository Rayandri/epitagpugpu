  ...
  return (
    <div className="flex flex-col items-center justify-center gap-8 p-12 max-w-4xl">
      ...
      >
        ...
        <a 
          href="https://github.com/Rayandri/epitagpugpu" 
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 text-[#76B900] hover:text-[#8ed000] transition-colors text-sm"
        >
          ...
          Open Source - github.com/Rayandri/epitagpugpu
        </a>
      </motion.div>
    </div>
  );
