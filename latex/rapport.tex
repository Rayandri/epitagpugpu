...
\def\authorvar{Rayan Drissi, Emre Ulusoy, Marc Guillemot, Paul Abi Saad}
\def\classevar{ING3}
\def\anneevar{2025}
...
Les tests ont été réalisés sous \textbf{WSL2} (Windows Subsystem for Linux 2) avec Ubuntu 22.04.5 LTS.
